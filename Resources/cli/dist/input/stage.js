...
export function walkScripts(dir, acc = [], exts = [".js", ".mjs"]) {
    let entries;
    try {
...
export function rewriteExtensionIdPlaceholderUrls(stageDir) {
    let modified = 0;
    for (const file of walkScripts(stageDir, [], [".js", ".mjs", ".css", ".html", ".htm"])) {
        ...
        if (!content.includes("chrome-extension://__MSG_@@extension_id__"))
            continue;
